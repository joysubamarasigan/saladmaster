    ...
    class ReduxFramework_slides {
        ...
        public function render () {
            ...
            if ( $x == 0 ) {
				...
				$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'subtitle' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'subtitle' ] ) : __ ( 'Subtitle', 'redux-framework' );
				echo '<li><input type="' . $subtitle_type . '" id="' . $this->field[ 'id' ] . '-title_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title]' . $this->field['name_suffix'] .'" value="" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
