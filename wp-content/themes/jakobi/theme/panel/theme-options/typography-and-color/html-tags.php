...
return array(
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h2, .portfolio_big_image h2.post-title.portfolio-title a, .portfolio_small_image h2.post-title.portfolio-title a',
            'properties'  => 'font-size,
                              font-family,
                              font-weight,
                              color,
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h3,.tabs-container ul.tabs li h4 a, .features-tab-container ul.features-tab-labels li h4 a, .yit_shortcodes.last-post h3 a',
            'properties'  => 'font-size,
                              font-family,
                              font-weight,
                              color,
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h4, .toggle h4.tab-index a, .toggle h4.tab-index a:hover,
                             .cart-collaterals th',
            'properties'  => 'font-size,
                              font-family,
                              font-weight,
