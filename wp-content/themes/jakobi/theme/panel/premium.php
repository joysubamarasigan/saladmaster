...
$premium_theme_name = 'jakobi';

$yithemes_landing = 'http://yithemes.com/themes/wordpress/free-wp-single-page-themes/';

$name = 'Jakobi - One Page wordpress theme';
...
.container ul.free-features li img, ul.premium-features li img {float:left;margin:0 15px 50px 0;padding:3px;border:1px solid #d4d5d5;}
...
<div class="container bolder-tpl landing">
    ...
    <ul class="premium-features">
        ...
        <li>
            <img src="<?php echo $images_url ?>/visual_composer.jpg" alt="<?php echo $name ?>" />

            <h3>Visual Composer</h3>

            <p>
                Responsive Drag & Drop Page Builder with Frontend and Backend Editors.
            </p>
        </li>
        ...
        <li>
            <img src="<?php echo $images_url ?>/sliders.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $images_url ?>/backup.jpg" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $images_url ?>/cps.jpg" alt="<?php echo $name ?>" />

            <h3>Custom Post Types</h3>

            <p>
                Team, Testimonias, Feature Tabs, Services e other custom post type to customize your pages.
            </p>
        </li>
