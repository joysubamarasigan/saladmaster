...
<div id="<?php echo $field['id'] ?>-container" class="yit_options rm_option rm_input rm_number rm_text" <?php if ( isset($deps) ): ?>data-field="<?php echo $field['id'] ?>" data-dep="<?php echo $field['prefix'] . $deps['ids'] ?>" data-value="<?php echo $deps['values'] ?>" <?php endif ?>>
    <label for="<?php echo $field['id'] ?>"><?php echo $field['label'] ?></label>
            <span class="field">
                <input class="number" type="number" id="<?php echo $field['id'] ?>" name="<?php echo $field['name'] ?>" <?php if(isset($field['min']) && isset($field['max'])) echo $field['min'].' '.$field['max'] ?> value="<?php echo $field['value'] ?>" <?php if( isset( $field['std'] ) ) : ?>data-std="<?php echo $field['std'] ?>"<?php endif ?>" />
